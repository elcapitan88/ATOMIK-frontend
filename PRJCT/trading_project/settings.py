...
SECRET_KEY = 'django-insecure-your-secret-key-here'  # Replace this with a secure secret key
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Note: This should be as high as possible
