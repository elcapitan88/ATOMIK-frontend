...
import { Shield, DollarSign, Webhook, Radio, Store, TrendingUp } from 'lucide-react';
              ...
              >
                ...
                >
                  <VStack spacing={4} align="flex-start">
                    ...
                    >
                      <Icon as={Radio} boxSize={6} />
                    </Box>
                    <Heading as="h3" size="md" color="white" fontWeight="600">
                      Trade Mirroring
                    </Heading>
                    <Text color="whiteAlpha.800" fontSize="sm" lineHeight="1.7">
                      Place one trade and every account you own executes it. Built for prop traders managing multiple funded accounts — one order, all accounts, simultaneous execution.
                    </Text>
                  </VStack>
                </Box>
              </MotionBox>
